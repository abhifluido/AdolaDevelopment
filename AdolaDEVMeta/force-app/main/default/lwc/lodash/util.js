  ...
  return flatRest(function(funcs) {
    ...
    while (++index < length) {
      ...
      if (data && isLaziable(data[0]) &&
            data[1] == (WRAP_ARY_FLAG$3 | WRAP_CURRY_FLAG$5 | WRAP_PARTIAL_FLAG$4 | WRAP_REARG_FLAG$2) &&
...
function times(n, iteratee) {
  ...
  var index = MAX_ARRAY_LENGTH$1,
      length = nativeMin$2(n, MAX_ARRAY_LENGTH$1);
...
export { attempt, bindAll, cond, conforms, constant, defaultTo, flow, flowRight, identity, iteratee, matches, matchesProperty, method, methodOf, mixin, noop, nthArg, over, overEvery, overSome, property, propertyOf, range, rangeRight, stubArray, stubFalse, stubObject, stubString, stubTrue, times, toPath, uniqueId };