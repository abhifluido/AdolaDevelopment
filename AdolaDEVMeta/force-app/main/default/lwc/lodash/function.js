...
var partial = baseRest(function(func, partials) {
  ...
  return createWrap(func, WRAP_PARTIAL_FLAG$5, undefined, partials, holders);
});
partial.placeholder = {};
...
var rearg = flatRest(function(func, indexes) {
  return createWrap(func, WRAP_REARG_FLAG$2, undefined, undefined, undefined, indexes);
});
...
function spread(func, start) {
  ...
  start = start == null ? 0 : nativeMax$5(toInteger(start), 0);
  return baseRest(function(args) {
...
export { after, ary, before, bind, bindKey, curry, curryRight, debounce, defer, delay, flip, memoize, negate, once, overArgs, partial, partialRight, rearg, rest, spread, throttle, unary, wrap };